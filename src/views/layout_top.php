...
<title><?= htmlspecialchars($titolPagina ?? APP_NAME) ?></title>
...
<!-- Estils propis -->
<style>
<?php include __DIR__ . '/layout_styles.css'; ?>
</style>
...
<aside class="sidebar">
    ...
    <div class="sidebar-brand text-center">
        <img src="<?= BASE_URL ?>/assets/img/logo.png" alt="Logo centre" style="width:80px; margin-bottom:10px;">
        <h1><i class="bi bi-book-half me-1"></i><?= APP_NAME ?></h1>
    ...
    <div class="nav-section">Importacions</div>
    ...
    <a href="<?= BASE_URL ?>/professors/importar.php"
      ...
      <i class="bi bi-upload"></i> Importar professorat
    </a>
    ...
    <a href="<?= BASE_URL ?>/classes/importar.php"
      ...
      <i class="bi bi-upload"></i> Importar classes
    </a>

    <a href="<?= BASE_URL ?>/llibres/importar.php"
       class="nav-link <?= ($paginaActiva??'')==='import_llibres'?'active':'' ?>">
      <i class="bi bi-upload"></i> Importar llibres
    </a>

    <?php endif; ?>

    <div class="sidebar-footer">
      <div><strong><?= htmlspecialchars(Auth::nom()) ?></strong></div>
      <div class="mt-1">
        <?php if (Auth::rol()==='admin'): ?>
      ...
      <a href="<?= BASE_URL ?>/logout.php" class="d-block mt-2 text-decoration-none"
